...
const NavBar = () => {
    return (
        <div>
            <nav >
                <div className="bg-white shadow-md py-4 px-4 sm:px-6 flex flex-col sm:flex-row sm:justify-between sm:items-center sticky top-0 z-50 gap-7 sm:space-y-0" >
                    ...
                    <div className="flex justify-between items-center">
                        <Link to="/">
                            ...
                            <p className='text-xs font-bold text-[#FF6F5E]'>Your accessories are here </p>
